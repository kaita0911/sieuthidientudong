...
namespace VCMS.MVC4.Web.Controllers
{
    ...
    public class HomeController : BaseController
    {
        public ActionResult Index()
        {
            ...
            var adv = db.Articles.Include(a => a.ArticleType).Where(a => a.ArticleTypeId == 5).OrderBy(a => a.SortOrder).Skip(0).Take(2);
            ...
            var banner = db.Articles
                ...
                .Where(a => a.ArticleTypeId == 4).OrderBy(a => a.SortOrder).Skip(0).Take(5);
            ViewBag.Banner = banner.ToList();

            var partner = db.Articles
               .Include(a => a.ArticleType)
               .Include(a => a.PropertyValues.Select(p => p.Property))
               .Where(a => a.ArticleTypeId == 9).OrderBy(a => a.SortOrder);
