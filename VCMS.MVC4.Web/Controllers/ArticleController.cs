...
namespace VCMS.MVC4.Web.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        public ActionResult InfinateScrollCategory(int cateId, int pageSize = 20)
        {
            ...
            var model = Article.GetByCategory(cateId, SiteConfig.LanguageId, flags: Flag, pageIndex: 1, pageSize: pageSize, includeflags : ArticleIncludeFlags.ARTICLE_TYPE | ArticleIncludeFlags.ARTICLE_DETAIL | ArticleIncludeFlags.PRICES | ArticleIncludeFlags.PROPERTIES);
